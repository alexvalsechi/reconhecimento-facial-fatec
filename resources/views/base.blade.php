...
<body>
    <div class="min-h-full">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="{{route('listar')}}"
                                    ...
                                    aria-current="page">Listagem Ponto</a>

                                <a href="{{route("registro")}}"
                                    class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Registrar ponto</a>

                                <a href="{{route('sair')}}"
                                    class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Sair do sistema</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
        ...
        <main>
            <div class="max-w-7xl mx-auto py-6 sm:px-4 lg:px-4 h-3">
